	...
	const handleAccept = useCallback(async () => {
		...
		try {
			...
			if (result.status === 200) {
				toast.success(`Joined workspace as ${result.data.role}`)
					...
					{isExpired ? (
						...
						<div className="space-y-3">
							...
							<Link
								...
								className="flex h-11 w-full items-center justify-center bg-primary font-mono text-[11px] font-bold tracking-[0.5px] text-[#0C0C0C] hover:bg-primary/90"
							>
								SIGN IN WITH EMAIL
							</Link>
